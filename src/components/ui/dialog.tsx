  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-lg border border-ink-3 bg-ink-1 p-5 shadow-xl',
        'focus:outline-none',
        className,
      )}
      {...props}
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-3 top-3 rounded-md p-1 text-bone-muted hover:bg-ink-2 hover:text-bone"
        aria-label="Close"
      >
        <X className="h-4 w-4" />
      </DialogPrimitive.Close>
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('text-lg font-semibold text-bone', className)}
    {...props}
  />
));
